 ...
 */
final class Version20230820105234 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE team_match ADD day INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX team_match_unique ON team_match');
        $this->addSql('ALTER TABLE team_match DROP day');
